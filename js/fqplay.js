...
bolie1 +='<li class="'+boliee+'" ><a href="#'+bolie[h]+'">'+bolie[h]+'</a></li>';
  ...
  {
      neirong1 +='<li class="am-btn am-btn-sm btn-play-source"><a href="https://jiexi.8b5q.cn/player/jx.php?url='+str1[h][i+1]+'"  target="ajax" onclick="GetHref(this);return false;">'+str1[h][i]+'</a>';
  }

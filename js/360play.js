...
//内容开始
url1="https://api.web.360kan.com/v1/detail?cat="+id;
$(function(){
$.ajax({
          type: "get",
           ...
           success: function(data) {
			  // console.log(data);
			   ...
			   for (var key in bolie){
				   neirong1 +='<li class="am-btn am-btn-sm btn-play-source"><a href="./jx/index.html?url='+bolie[key].default_url+'"  target="ajax" onclick="GetHref(this);return false;">'+bolie[key].site+'</a></li>';
...
bolie1 +='<li class="'+boliee+'" ><a href="#'+key+'">'+key+'</a></li>';  		   
	for (i=0;i<bolie[key].length ;i++){
		neirong1 +='<li class="am-btn am-btn-sm btn-play-source"><a href="./jx/index.html?url='+bolie[key][i].url+'"  target="ajax" onclick="GetHref(this);return false;">'+bolie[key][i].playlink_num+'</a></li>';
	...
	break;
		...
		neirong1 +='<li class="am-btn am-btn-sm btn-play-source"><a href="./jx/index.html?url='+bolie[i].url+'"  target="ajax" onclick="GetHref(this);return false;">'+bolie[i].period+'</a></li>';

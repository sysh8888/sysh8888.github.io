...
{
   iptv +='<li class="am-btn am-btn-sm btn-play-source"><a href="/live/ifb.html?url=http://ivi.bupt.edu.cn/'+lian1[i]+'"  target="ajax" onclick="GetHref(this);return false;">'+timu1[i]+'</a></li>';
}

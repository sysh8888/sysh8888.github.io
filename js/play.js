...
bolie1 +='<li class="'+boliee+'" ><a href="#'+bolie[h]+'">'+bolie[h]+'</a></li>';
  ...
  {
      neirong1 +='<li class="am-btn am-btn-sm btn-play-source"><button type="button" class="am-btn am-btn-sm am-round" title="'+str1[h][i]+'" value="'+jx+str1[h][i+1]+'"  onclick="GetHref(this);">'+str1[h][i]+'</button></li>';
  }
